...
inline double get_gauss_prob(double std_x,double std_y,double p_x,double o_x,double p_y,double o_y)
{
	return ( 1/(2*M_PI*std_x*std_y)) * exp( -( pow(p_x-o_x,2)/(2*pow(std_x, 2)) + (pow(p_y-o_y,2)/(2*pow(std_y, 2))) ) );
}
